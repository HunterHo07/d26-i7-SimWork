...
export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-dark-300 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Logo className="h-10 w-auto mb-4" />
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              SimWork: The future of work simulation platform that revolutionizes how people learn, practice, and demonstrate professional skills.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <FooterLink href="/showcase" label="Showcase" />
              <FooterLink href="/roadmap" label="Roadmap" />
              <FooterLink href="/pitch-deck" label="Pitch Deck" />
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <FooterLink href="/why-us" label="Why Us" />
